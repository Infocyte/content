...
def file_command(file: str, client: Client) -> CommandResults:
    return build_indicator(file, 'hash', '## Falcon Intel file reputation for:\n', client)


def ip_command(ip: str, client: Client) -> CommandResults:
    return build_indicator(ip, 'ip', '## Falcon Intel IP reputation for:\n', client)


def url_command(url: str, client: Client) -> CommandResults:
    return build_indicator(url, 'url', '## Falcon Intel URL reputation for:\n', client)


def domain_command(domain: str, client: Client) -> CommandResults:
    return build_indicator(domain, 'domain', '## Falcon Intel domain reputation for:\n', client)
